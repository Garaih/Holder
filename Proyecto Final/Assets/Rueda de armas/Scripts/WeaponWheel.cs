...
namespace GTAWeaponWheel.Scripts
{
    public class WeaponWheel : MonoBehaviour
    {
        ...
        [SerializeField] private Wheel[] wheels = new Wheel[12];

        
        [Header("Dots & Lines")]
        [SerializeField] private Transform[] dots = new Transform[13];
        private Vector2[] pos = new Vector2[13];
        ...
        private void CheckForCurrentWeapon()
        {
            ...
            }else if (IsInside(pos[0], pos[8], pos[9], mousePos))
            {
                EnableHighlight(7);
                WeaponSwitcher.instance.SwitchWeapon(7);
            }
            else if (IsInside(pos[0], pos[9], pos[10], mousePos))
            {
                EnableHighlight(8);
                WeaponSwitcher.instance.SwitchWeapon(8);
            }
            else if (IsInside(pos[0], pos[10], pos[11], mousePos))
            {
                EnableHighlight(9);
                WeaponSwitcher.instance.SwitchWeapon(9);
            }
            else if (IsInside(pos[0], pos[11], pos[12], mousePos))
            {
                EnableHighlight(10);
                WeaponSwitcher.instance.SwitchWeapon(10);
            }
            else if (IsInside(pos[0], pos[12], pos[1], mousePos))
            {
                EnableHighlight(11);
                WeaponSwitcher.instance.SwitchWeapon(11);
            }
